...
class GroupViewModel : ViewModel() {
    ...
    fun getUsersData(): LiveData<List<UserItem>> {
        //MediatorLiveData позволяет подписаться на изменения нескольких LiveData
        ...
        //указываем на какую LiveData подписаться это userItems и query
